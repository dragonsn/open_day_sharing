...
public:
	...
	void FindClassMetaData(const FString & className, TArray< FString> & result);
	void LoadExternalMetaData(FString InModuleFileName);
	//META_INFO_OPT]
...
private:
	...
	TMap< FString, TArray< FString> > ClassPropertyMetaTable;
	TMap< FString, TArray< FString> > ScanedDirectory;
	//META_INFO_OPT]
};
